...
const ItemTablaProducto = ({ producto, fila }: Props) => {
  return (
    <tr className="border-b border-gray-800 hover:bg-[#151515] transition-all">
      ...
      <td className="px-6 py-5">
        <div className="flex items-center justify-center gap-3">
          ...
          <button className="bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 px-4 py-2 rounded-xl transition-all">
            Editar
          </button>

          <button className="bg-red-500/10 hover:bg-red-500/20 text-red-400 px-4 py-2 rounded-xl transition-all">
            Eliminar
          </button>
