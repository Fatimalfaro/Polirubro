  ...
  return (
    <div className="bg-neutral text-neutral-content rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 border border-zinc-800 flex flex-col h-full">
      ...
      <div className="p-5 flex flex-col flex-grow bg-zinc-950">
        ...
        <button className="w-full mt-5 bg-green-600 text-black py-2.5 rounded-xl font-extrabold hover:bg-green-500 active:scale-95 transition-all duration-200 shadow-md shadow-green-900/20 uppercase text-xs tracking-wider">
          Ver detalle
        </button>
      </div>
    </div>
